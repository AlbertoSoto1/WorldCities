...
namespace WorldCities.Data
{
  public class ApiResult<T>
  {
    ...
    /// <param name="pageIndex">Zero-based current page index (o = first page)</param>
    ...
    /// <returns>
    /// A object containing the paged/sorted/filtered result and all the relevant
    ...
    #region Methods
    /// <summary>
    /// Checks if the given property name exists to protect agains 
